...
for dataset in dataset_names:
    ...
    if os.path.isfile(f'{ROOT_DIR}/f1_scores/evaluation_rf.csv'):
        df_result.to_csv(f'{ROOT_DIR}/f1_scores/evaluation_rf.csv', mode='a', header=False, index=False)
    else:
        df_result.to_csv(f'{ROOT_DIR}/f1_scores/evaluation_rf.csv', index=False)
